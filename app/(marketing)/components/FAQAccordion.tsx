...
const FAQS = [
  ...
  { q: 'What does Caliber Calendar cost?', a: 'Pricing is per-show and varies based on your target asset criteria, geography, and monthly volume. Because you only pay when a qualified prospect sits down with you, there are no retainers, no setup fees, and no wasted spend. Exact cost-per-show is discussed on your discovery call once we understand your target market. Most advisors see a 3–5× ROI within the first 60 days.' },
  { q: 'How quickly can I start receiving appointments?', a: 'Most advisors are receiving their first confirmed appointments within 2–3 weeks of onboarding. We move fast — once your profile, calendar, and asset criteria are set, our targeting and outreach process begins immediately. Volume ramps up over the first 30 days as we dial in your specific market.' },
