...
const BENEFITS = [
  {
    ...
    description:
      'Every appointment is double-confirmed and pre-educated. Prospects know exactly what the call is about and have committed their time. You don\'t pay for ghosts.',
    stat: '97%',
    statLabel: 'Show Rate',
  },
  {
    ...
    description:
      'Unlike Facebook leads or direct mail, you only spend money when a real, qualified prospect actually sits down with you. No guessing. No burning budget on cold lists.',
    stat: '$0',
    statLabel: 'Pay if No-Show',
  },
  {
    icon: Users,
    title: 'Genuinely Qualified Prospects',
    description:
      '$500K–$2M+ in verified investable assets. Pre-screened for annuity and wealth planning fit. These aren\'t "interested in learning more" forms — these are real buyers.',
    stat: '$500K+',
    statLabel: 'Min. Assets',
  },
  {
    icon: TrendingUp,
    title: 'Consistent, Scalable Pipeline',
    description:
      'Set your target volume and we fill your calendar. No feast-or-famine cycles. No slow months. A predictable appointment flow you can actually build a business around.',
    stat: '4.2×',
    statLabel: 'Avg. ROI',
  },
  {
    icon: Clock,
    title: 'Reclaim Your Selling Time',
    description:
      'Stop wasting hours on cold calls, seminars, and unqualified referrals. We handle targeting, pre-education, setting, and confirmation. You show up and run your process.',
    stat: '10+',
    statLabel: 'Hours Saved/Week',
  },
  {
    icon: Layers,
    title: 'Fully Turnkey System',
    description:
      'From prospect identification to pre-call education to appointment setting and confirmation — the entire system runs without you. Plug in your close rate and scale.',
    stat: '100%',
