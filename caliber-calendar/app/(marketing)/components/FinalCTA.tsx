          ...
          <div id="qualify">
            <div className="bg-[#0E243A] border border-white/10 rounded-2xl p-8">
              ...
              <div className="bg-[#0A192F] border border-white/[0.06] rounded-xl min-h-[340px] flex flex-col items-center justify-center gap-4 p-8 text-center mb-6">
                ...
                <div>
                  <div className="text-white font-semibold mb-1">Calendly Widget</div>
                  <div className="text-slate-500 text-sm max-w-xs">
                    Embed your Calendly booking link here. Set{' '}
                    <code className="text-emerald-400 text-xs bg-emerald-600/10 px-1.5 py-0.5 rounded">
                      NEXT_PUBLIC_CALENDLY_URL
                    </code>{' '}
                    in your .env and drop in the embed script.
                  </div>
                </div>
              </div>

              {/* OR divider + direct CTA */}
            ...
            <div className="mt-5 text-center text-slate-500 text-sm">
              Not ready to book?{' '}
              <a href="#roi" className="text-emerald-400 hover:text-emerald-300 transition-colors font-medium">
                Run the ROI Calculator first →
              </a>
            </div>
          </div>
        </div>
